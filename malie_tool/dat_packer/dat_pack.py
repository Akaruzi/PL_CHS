...
# ExpectHeader = bytes.fromhex('AC BF 54 63 AA 01 6E 32')
# ExpectHeader = bytes.fromhex('AC BF 54 63 AA 01 6E 32') # kkk
ExpectHeader = bytes.fromhex('75 01 39 79 BB E1 3F 01') # pl
# bansenjin
# ExpectHeader = bytes.fromhex('4C 68 D0 BD BB F7 A0 DF')  
# di_aa
# ExpectHeader = bytes.fromhex('5D C4 43 14 18 7B BA 5B')  


# kkk_r18
# ExpectHeader = bytes.fromhex('B2 66 54 8B F7 CF 5C 48')
